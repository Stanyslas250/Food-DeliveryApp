...
class Landing2(ft.View):
    def __init__(self, page: ft.Page):
        super(Landing2, self).__init__(
            route='/Landing2', horizontal_alignment="center",
        ...
        self.design = ft.Column(
                        ...
                        controls= [ ft.Container(
                                height=292,
                                content= ft.Image(src='/image/image2.jpeg',fit=ft.ImageFit.FILL,border_radius=ft.border_radius.all(10))
                            ),
                            ft.Container(
                                ft.Column([
                                    ft.Text('Order from choosen chef',color='#000000',weight='bold',size=24),
                            ...
                            ft.Container(
                                ft.Column([
                                    ft.TextButton(text='Next',width=327,height=62,style=ft.ButtonStyle(color='white',bgcolor='#ff7622',
                                                  ...
                                                  on_click=lambda e: self.page.go('/Landing3')),
